...
func TestGetUserAPI(t *testing.T) {
	...
	testcases := []struct {
		...
		{name: "DuplicateUsername", body: gin.H{
			"username":  user.Username,
			"full_name": user.FullName,
			"email":     user.Email,
			"password":  password,
		...
		{name: "InvalidUsername", body: gin.H{
		...
		{name: "TooShortPassword", body: gin.H{
			"username":  user.Username,
			"full_name": user.FullName,
			"email":     user.Email,
			"password":  "123",
